...
from tracefang.domain.options import OptionChainSnapshot, OptionDeliveryMode
from tracefang.infrastructure.providers.shfe_options.protocol import (
    parse_shfe_gold_option_chain,
)
from tracefang.infrastructure.providers.shfe_options.settings import (
